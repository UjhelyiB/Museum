...
public class MapFragment extends TabChildFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onLocationChanged(final Location location) {
        ...
        if(visitLocationChallenge != null && visitLocationChallenge.getGoalLocation().distanceTo(userLocation) < 11){
